                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('{{ asset('img/profil-ubaya.jpg') }}'); background-size: cover;">
                                <span class="mask bg-gradient-primary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Tim hebat dibangun dari pilihan yang tepat"</h4>
                                <p class="text-white position-relative">Temukan, nilai, dan kembangkan anggota kepanitiaan terbaik dengan sistem yang transparan dan terpercaya.</p>
                            </div>
                        </div>
                    </div>
                </div>
