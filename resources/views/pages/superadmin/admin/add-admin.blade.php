...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tambah Admin Kepanitiaan'])
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <div class="card">
                    <form method="POST" action="{{ route('store.admin.super') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Tambah Admin Kepanitiaan</p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="organizer_unit" name="organizer_unit">
                                            ...
                                            @foreach ($organizerUnits as $unit)
                                                <option value="{{ $unit->idOrganizerUnits }}">{{ $unit->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
