...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('assets_lp/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('assets_lp/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-1.jpg') }}" alt="" class="img-fluid">
              </div>
              <h3>Storage</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-2.jpg') }}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-3.jpg') }}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-4.jpg') }}" alt="" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-5.jpg') }}" alt="" class="img-fluid">
              </div>
              <h3>Packaging</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="card">
              <div class="card-img">
                <img src="{{ asset('assets_lp/img/service-6.jpg') }}" alt="" class="img-fluid">
              </div>
